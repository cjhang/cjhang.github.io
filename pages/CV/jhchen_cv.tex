...
\begin{paperlist}
  ...
  \item {\bf VLA} VLA/25B-195, \emph{Probing the jet-BLR connection in an early accreting efficient SMBH}, {\bf 7.3\,hrs}
...
\section{Professional training}
  \CVSubHeadingListStart
    \CVSubheading
      {Fundamentals of Deep Learning}{9 Dec. 2025}
      {Max Planck Computing and Data Facility workshop}{Garching, Germany}
    %\CVSubheading 
...
%      {Institution you worked with}{unused}
    \CVSubheading
      {NOEMA3D: Resolving the molecular gas in cosmic-noon galaxies}{26 Sept. 2025}
      {Conference: The 12th Sino-German Meeting on Galaxy formation}{Chengdu, China}
    \CVSubheading
      {The efficient development of coherent magnetic fields in distant galaxies}{16 Sept. 2025}
      {Mars Forum, Nanjing University}{Nanjing China}
    \CVSubheading
      {Resolving the molecular gas in cosmic-noon galaxies}{15 Sept. 2025}
      {\textbf{Invited talk}, Purple Mountain Observatory Seminar}{Nanjing, China}
    \CVSubheading
      {Resolving the inner workers of the cosmic noon galaxies with VLT, ALMA, NOEMA, and JWST}{3 Sept. 2025}
      {Thirty Minutes Talk, ESO Vitacura}{Santiago, Chile}
    \CVSubheading
      {The Magnetized Universe Under Cosmic Lensing}{8 May 2025}
      {Conference: PASSAGES Annual Meeting (joined online)}{Charlottesville, USA}
    \CVSubheading 
      {\small The Inner Workings of Cosmic Noon Galaxies on Sub-kpc Scales with VLT/ERIS and JWST}{16 Jun. 2025}
      {Quo Vadis Galaxy Evolution?}{Heidelberg, Germany}
    \CVSubheading
      {Signposting Proto-cluster Cores with Clusters of Sub-Millimeter Galaxies}{14 May 2025}
      {\textbf{Invited talk}: From fake news to real clusters}{Tenerife, Spain}
    \CVSubheading
      {Mapping polarised dust emission across cosmic time}{9 Dec. 2024}
      {Conference: Dust and Gas throughout Cosmic Time}{Hiroshima, Japan}
    \CVSubheading
      {A new window to reveal the magnetised early Universe}{30 Nov. 2024}
      {\textbf{Invited talk}: SAGI 2nd Astrophysics Workshop (joined online)}{Quy Nhon, Vietnam}
    \CVSubheading
      {Witness the formation of the brightest cluster galaxies}{4 Jul. 2024}
      {Conference: EAS 2024}{Padova, Italy}
    \CVSubheading
      {\small Early development of kpc-scale magnetic fields at Cosmic Dawn traced by the polarised dust emission}{3 Jul. 2024}
      {Conference: EAS 2024}{Padova, Italy}
    \CVSubheading
      {A new window to reveal the magnetised early Universe}{9 Dec. 2023}
      {Conference: ALMA at 10 years: Past, Present, and Future}{Puerto Varas, Chile}
    \CVSubheading
      {Witness the formation of the brightest cluster galaxies}{11 Aug. 2023}
      {Conference: Asia-Pacific Regional IAU Meeting 2023}{Koriyama, Japan}
    \CVSubheading
      {Multi-band ALMA survey for dusty star-forming galaxies}{27 Jun. 2023}
      {Conference: Millimeter Universe 2023}{Grenoble, France}
    \CVSubheading
      {Dusty, star-forming galaxies}{11~Jan. 2023}
      {\textbf{Invited talk}: ASIAA Colloquium}{Remote}
    \CVSubheading
      {Opportunities with dusty, star-forming galaxies}{9~Jan. 2023}
      {\textbf{Invited talk}: MPE Seminar talk}{Garching, Germany}
    \CVSubheading
...
%      {Who you worked for}{Where they are located}
    \CVSubheading
      {Reviewer for Monthly Notices of the Royal Astronomical Society}{2024}
    ...
    \CVSubheading
      {Reviewer for Publications of the Astronomical Society of Japan}{2020}
      {Review journal paper}{}
  \CVSubHeadingListEnd
...
\section{Skills}
 \begin{itemize}[leftmargin=0.5cm, label={}]
    \small{\item{
     ...
     \textbf{Programming}{: Python (NumPy, SciPy, Matplotlib, Astropy, Pytorch), MATLAB, Mathematica} \\
     \textbf{Document Creation}{: HTML, LaTex, Markdown} \\
     \textbf{Software}{: pPXF, CASA, CARTA, DS9, BBarolo, Galpak, Dysmalpy}
    }}
 \end{itemize}
...
\vspace{1em}
\\
$\bullet$ \ Dr.\,Linda Tacconi \\
\hphantom{$\bullet$} \ Max Planck Institute for Extraterrestrial Physics\\
\hphantom{$\bullet$} \ \href{mailto:linda@mpe.mpg.de}{linda@mpe.mpg.de} 
\vspace{1em}
\\
$\bullet$ \ Dr.\,Martin Zwaan \\
\hphantom{$\bullet$} \ ALMA Regional Center / ESO \\
\hphantom{$\bullet$} \ \href{mailto:mzwaan@eso.org}{mzwaan@eso.org} 
\end{minipage}
\begin{minipage}[t]{0.52\textwidth}
$\bullet$ \ Dr. Natascha M. F\"orster Schreiber \\
\hphantom{$\bullet$} \ Max Planck Institute for Extraterrestrial Physics\\
\hphantom{$\bullet$} \ \href{mailto:forster@mpe.mpg.de}{forster@mpe.mpg.de}
\vspace{1em}
\\
...
\section{Publications in preparation and selected non-refereed publications:}
\begin{paperlist}
